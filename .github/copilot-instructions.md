...
- There is no client scaffolding here any more; `angular.json`, `webpack/` and `jest.conf.js` were deleted 2026-08-30. This repo has no deploy script: deployment lives in `hc-patient/deploy` (`kojoampia/hc-patient-ci`).
